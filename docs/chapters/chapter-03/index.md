...
再現手順がない不具合は、修正できても「直った」を検証できない。
...
ログやスクリーンショットには、トークンや個人情報などの機微情報が混入することがある。共有前に必ず確認し、必要に応じてマスキングする（参考: <https://itdojp.github.io/security-privacy-literacy-book/>）。
...
- ログやスクリーンショットには機微情報が混入し得るため、共有前に必ず確認する
