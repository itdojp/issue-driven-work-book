...
「後日再評価」として閉じる場合も、単に優先度を下げるのではなく、理由、代替案、再オープン条件、再確認期限、Owner を完了コメントに残す。記入済みの例は[ケーススタディ「後日再評価としてクローズする」](../../appendices/case-studies/#deferred-close-example)を参照する。
